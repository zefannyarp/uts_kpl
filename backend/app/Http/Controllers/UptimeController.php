...
class UptimeController extends Controller
{
    ...
    public function getUptime7days(Uptime $uptime)
    {
        $end_date = Carbon::now()->format('U') * 1000;
        $start_date = Carbon::now()->subWeek()->format('U') * 1000;
        ...
        $totals = DB::table('uptime_details')
            ->select(DB::raw('count(*) as total_error'))
            ->groupBy('date_time')
            ->get();
